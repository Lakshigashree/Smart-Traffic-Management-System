...
- Interactive map showing congestion density and vehicle movement  
- Designed for future integration with live camera feeds and AI models  

#### 3️⃣ Traffic Signals
- Monitoring and management of automated traffic signals  
- Signal status display (Red / Yellow / Green)  
- Scope for AI-based adaptive signal control  
